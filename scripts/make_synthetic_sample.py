...
NARRATION = (
    ...
    "A perfect design document helps no one. "
    "Let me leave you with three questions to ask every morning. "
    "First, what is the smallest thing I can finish today? "
    "Second, who will notice if I finish it? "
    "Third, what am I pretending not to know about this project? "
    "That last one stings, and that is exactly why it works. "
    "Most of us already know which feature is a distraction, "
    "which bug we are avoiding, and which conversation we owe a teammate. "
    "Writing it down turns a vague worry into a task, and tasks can be finished. "
    "Here is one more story before we wrap up. "
    "A friend of mine spent two years polishing a note taking app nobody asked for. "
    "Then she spent two weekends building a tiny script that renamed photo files, "
    "and strangers still thank her for it every month. "
    "The lesson is not that big projects are bad. "
    "The lesson is that usefulness is discovered, not designed. "
    "Ship small, listen hard, and let real people tell you what matters. "
    "Do that for a year and you will be amazed where you end up. "
    "Thank you for listening, and now go finish something."
)
